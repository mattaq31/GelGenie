        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch}/{epochs}', unit='img') as pbar:
            ...
            for batch in train_loader:
               ...
               # For the last batch
                ...
                test_val_score, test_image, test_mask_pred, test_mask_true = evaluate(net, train_loader, device)
                ...
                if len(test_dice_log) == epoch:  # Already exists dice score for this epoch
                    test_dice_log[epoch-1] = test_val_score.item()  # Replace it
                else:  # No dice score yet for this epoch
                    test_dice_log.append(test_val_score.item())  # Append one into it
